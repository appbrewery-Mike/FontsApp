...
class KeyboardViewController: UIInputViewController {
    ...
    // MARK: - FUNCTION FOR FONTS
    
    func chooseFont(){
        let fontsPickerNib = UINib(nibName: "FontsPicker", bundle: nil)
        fontsPickerView = fontsPickerNib.instantiate(withOwner: self, options: nil)[0] as? UIView
         view.addSubview(fontsPickerView)
    }
